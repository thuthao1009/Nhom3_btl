                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <?php  
                            if(!isset($_SESSION['da_dang_nhap'])) {
                                ...
                                echo'<li><a class="dropdown-item" href="thong_tin_tai_khoan.php">Thông tin tài khoản</a></li>';
                                echo'<li><a class="dropdown-item" href="them_moi_san_pham.php">Đăng bán tài liệu</a></li>';
