            ...
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        ...
                        <li><a class="text-decoration-none" href="tin_tuc.php">Tin tức</a></li>
                        <li><a class="text-decoration-none" href="shop.php">Sản phẩm</a></li>
                        <li><a class="text-decoration-none" href="cau_hoi_thuong_gap.php">Thông tin</a></li>
                        <li><a class="text-decoration-none" href="contact.php">Liên hệ</a></li>
                    </ul>
                </div>
