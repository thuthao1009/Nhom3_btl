...
<body>
    ...
    $sql = "SELECT * FROM `sanpham` JOIN theloai ON sanpham.tl_id=theloai.tl_id JOIN user ON user.user_id=sanpham.user_id_b JOIN danhmucsp ON `danhmucsp`.`dm_id`=  `sanpham`.`dm_id`   WHERE sanpham.sp_id=".$id;
                    ...
                    <div class="card">
                        <div class="card-body" >
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a href="nguoi_dang.php?id=<?php echo $row['user_id_b']?>" class=" text-decoration-none" style=" color: black;"><?php echo $row['user_hoten']  ?>
                                    </a>
                                </li>
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        ...
                        <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="assets/img/<?php echo $row_lq['sp_anh_minh_hoa'] ?>">
                            <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    ...
                                    <input type="hidden" name="nguoi_ban" value="<?php  echo $row_lq['user_id_b'] ?>">
