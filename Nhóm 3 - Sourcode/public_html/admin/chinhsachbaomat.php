                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <p>Đối tượng được tiếp cận với thông tin cá nhân của khách hàng là thành viên ban quản trị
                        ...
                        <p>Liên hệ qua email: <a href="mailto:webba.web000@gmail.com">webba.web000@gmail</a>.</p>                               
                    </div>
                </main>
                <footer  class="py-4 bg-light mt-auto"  > 
                    <div class="container-fluid px-4" >
                        <div class="d-flex align-items-center justify-content-between small">
                            ...
                            <div>
                            <p><strong>Xin chân thành cảm ơn các bạn đã dành thời gian để đọc chính sách bảo mật và điều khoản của BA book!</strong></p>                         
                            </div>
                        </div>
                    </div>
                </footer>
