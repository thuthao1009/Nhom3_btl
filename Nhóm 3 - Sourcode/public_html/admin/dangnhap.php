...
<html lang="en">
    <head>
        ...
        <title>Đăng Nhập - LazaBa ADMIN</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method = "POST" action = "kiem_tra_dang_nhap_tk_admin.php">
                                            ...
                                            <div class="card-footer text-center py-3">
                                                <div class="small"><a href="dangki.php">Bạn chưa có tài khoản? Đi tới trang đăng ký.</a></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
