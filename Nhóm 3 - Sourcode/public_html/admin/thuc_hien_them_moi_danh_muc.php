...
<html lang="en">
    ...
    <?php
            ...
            $noi_dat_file_anh="../img/".basename($_FILES['txtAnhMinhHoa']['name']);

            $file_du_lieu_anh=$_FILES['txtAnhMinhHoa']['tmp_name'];
            $up_anh_len_he_thong= move_uploaded_file($file_du_lieu_anh, $noi_dat_file_anh);
            if(!$up_anh_len_he_thong){
                $anh_minh_hoa=null;
            } else
            ...
            $sql="INSERT INTO `danhmucsp` (`dm_id`, `dm_ten_danh_muc`, `dm_anh_minh_hoa`) VALUES (NULL, '".$ten_danh_muc."', '".$anh_minh_hoa."')";
               // echo($sql); exit();
