...
<body>
    ...
    <p style="text-align: right;"><a href="../admin/them_moi_tin_tuc.php"><img src= "../assets/img/add.png" style="width: 30px; height: auto;"></a></p>
    <table>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align: center;"><a href="../admin/sua_tin_tuc.php?id=<?php echo $row["tt_id"];?>"><img src= "../assets/img/edit.jpg"style="width: 30px; height: auto;"></a></td>
            <td style="text-align: center;"><a href="../admin/xoa_tin_tuc.php?id=<?php echo $row["tt_id"];?>"><img src= "../assets/img/delete.jpg" style="width: 30px; height: auto;"></a></td>
        </tr>
        <?php 
        }
        ;?>
