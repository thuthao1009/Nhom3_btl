...
<html lang="en">
    <head>
        ...
        <title>Ba Book|Quản trị tin tức</title>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ;?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row["tt_noi_dung"];?></td>
                                            <td style="text-align: center;"><img src="../img/<?php echo $row["anh_minh_hoa"] ?>" width="50" height="30" /></td>
                                             <td><?php echo $row["so_luot_doc"];?></td>
                                            <td><?php echo $row["ad_id"];?></td>
                                            <td style="text-align: center;"><a href="../admin/xoa_tin_tuc.php?id=<?php echo $row["tt_id"];?>"><img src= "../img/delete.jpg" style="width: 30px; height: auto;"></a></td>
                                             <td style="text-align: center;"><a href="../admin/sua_tin_tuc.php?id=<?php echo $row["tt_id"];?>"><img src= "../img/edit.jpg" style="width: 30px; height: auto;"></a></td>
                                             <td style="text-align: right;"><a href="../admin/them_moi_tin_tuc.php"><img src= "../img/add.png" style="width: 30px; height: auto;"></a></td>
                                        </tr>
                                    <?php
                                        }
                                    ;?>
