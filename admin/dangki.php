...
<html lang="en">
    <head>
        ...
        <title>Đăng Ký - LazaBa ADMIN</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="dang_ky_kiem_tra_tk_admin.php" enctype="multipart/form-data">                                            
                                            <div class="form-floating mb-3 ">
                                                        <input class="form-control" id="txtAdHoten" name = "txtAdHoten" type="text" placeholder="Điền họ tên của bạn" />
                                                        <label for="txtAdHoten">Họ và Tên</label>
                                            </div>
                                            <div class="form-floating mb-3">
