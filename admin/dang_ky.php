...
<html lang="en">
    <head>
        ...
        <title>Đăng Ký - LazaBa User</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="dang_ky_kiem_tra.php" enctype="multipart/form-data">                                            
                                            <div class="form-floating mb-3 ">
                                                        <input class="form-control" id="txtUserHoten" name = "txtUserHoten" type="text" placeholder="Điền họ tên của bạn" />
                                                        <label for="txtUserHoten">Họ và Tên</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtsdt" name= "txtsdt" type="int" placeholder="Điền số điện thoại của bạn" />
                                                <label for="txtsdt">Số diện thoại</label>
                                            </div></div>
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="dang_nhap.php" >Bạn đã có tài khoản? Đi tới trang đăng nhập.</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
