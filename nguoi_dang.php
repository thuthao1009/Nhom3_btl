...
<body>
    ...
    $sql="SELECT * FROM sanpham WHERE user_id='".$id."' ORDER BY sp_id DESC LIMIT $from, $so_sp_1_trang";
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div id="img-avt">
                    ...
                    <p style="text-align: center;">Tên người đăng</p>
                ...
                <ul class="list-unstyled templatemo-accordion"  >
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none"  href="#moveto">
                            Gender
                            <i class="fa fa-fw fa-chvron-circle-down mt-1"></i>
            ...
            <div class="col-md-3 " >
                ...
                <!-- số trang -->
                 <div div="row">
                    ...
                    <?php 
                        $tong="SELECT sp_id FROM sanpham WHERE user_id='".$id."'";
                        ...
                        $so_trang= ceil($tong_sp/$so_sp_1_trang);
                            ...
                            for ($t=1; $t<=$so_trang ; $t++) { ?>
                                    <li class="page-item ">
                                        <a class="page-link rounded-0 mr-3 shadow-sm border-top-0 border-left-0 text-dark" href="nguoi_dang.php?id=<?php echo $id?>&trang=<?php echo $t ?>" tabindex="-1"><?php echo "$t" ?></a>
                                   <!--  // echo " 
