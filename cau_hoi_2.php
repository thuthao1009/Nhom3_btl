...
<head>
    <title>LazaBA - Làm thế nào để đăng sản phẩm lên LazaBA   </title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            <h1 class="h1">Làm thế nào đăng sản phẩm lên LazaBA?   </h1>
            <p>
  ...
  <div
            ...
            <h2> Bạn có thế thực hiện các bước dưới đây để đăng sản phẩm lên LazaBA:</h2>
            <ul>
                <ol>
                    <li>Trước tiên bạn cần có tải khoản trên LazaBA, nếu có thì bạn hãy đăng nhập tài khoản của mình vào, nếu chưa có hãy đăng kí một tài khoản mới.</li>
                    <li>Sau khi đăng nhập xong bạn hãy truy cập vào trang cá nhân của mình và nhấn tạo bài đăng.</li>
                    <li>Sau đó hãy điền đầy đủ các thông tin mà LazaBA cần và nhấn gửi.</li>
                    <li>Sau khi gửi thành công hãy đợi Email thông báo của LazaBA về bài đăng của bạn sau khi xét duyệt.</li>
                </ol>
            </ul>
