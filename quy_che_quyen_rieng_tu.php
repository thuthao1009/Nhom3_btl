...
<head>
    <title>BAbook - Quy chế quyền riêng tư   </title>
    <meta charset="utf-8">
...
<body>
    ...
    <ul> <p>
        BAbook tôn trọng và cam kết bảo vệ dữ liệu cá nhân của người dùng. Chúng tôi cam kết sẽ thực hiện các biện pháp liên quan để bảo vệ dữ liệu cá nhân của người dùng. Quy chế Quyền riêng tư này (“Quy chế”) được lập nhằm quy định cách thức chúng tôi thu thập, sử dụng, tiết lộ, lưu trữ và/hoặc xử lý dữ liệu khi bạn truy cập vào trang BAbook.</p>
    ...
    <h5 > 1.  Chúng tôi sẽ thu thập những thông tin cá nhân nào?</h5>
    <ul>
...
<h5>2.Mục đích thu thập thông tin cá nhân </h5>
<ul>
...
<h5>3. Các trường hợp chia sẻ thông tin cá nhân </h5>
<ul>
