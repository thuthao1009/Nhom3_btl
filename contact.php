...
<h2 style="font-size:20pt; color: orange; font-style: italic; font-weight: bold; font-family: arial;">Nếu có bất kì vấn đề gì bạn có thể liên hệ với chúng tôi qua một số cách thức dưới đây:  </h2>
  ...
  <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="m.jpg" style="width:600px; height: 400px";>
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  href="https://www.facebook.com/profile.php?id=100087253236628" class="h3 text-decoration-none"  style=" color: orange; font-family: arial;" >Truy cập trang Facebook của LazaBA - Để lại lời nhắn qua Messenger </a></li>
                                </a>
  ...
  <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="mail.png" style="width:600px; height: 400px";>
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                            ...
                            <div class="card-body">
                               ...
                               <div class="show-more"> 
                             <a style=" color: blue; font-style: italic; font-weight: bold; font-family: arial;" >lazabaweb@gmail.com
                        </a>
                            </div>
