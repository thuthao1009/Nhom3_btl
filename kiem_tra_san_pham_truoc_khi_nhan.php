...
<head>
    <title>LazaBA - Kiểm tra sản phẩm trước khi nhận   </title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            <h1 class="h1">Kiểm tra sản phẩm trước khi nhận hàng    </h1>
            <p>
  ...
  <div class="container-fluid bg-light py-3">
        <div class="col-auto">
            <p class="p">Việc giao hàng và vận chuyển sẽ do người bán tự thực hiện. Vì vậy trước khi nhận hàng và thanh toán bạn hãy kiểm tra lại sản phẩm xem có đúng với mô tả không để tránh việc nhận sai hàng hoặc mua phải sản phẩm khác với mô tả.
