...
<head>
    <title>LazaBA - Làm thế nào để mua hàng trên LazaBA   </title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            <h1 class="h1">Làm thế nào để mua hàng trên LazaBA?   </h1>
            <p>
  ...
  <div
            ...
            <h2> Bạn có thế thực hiện các bước dưới đây để mua hàng trên LazaBA:</h2>
            <ul>
                <ol>
                    ...
                    <li>Bạn có thể trao đổi với người bán về phương thức thanh toán, phương thức vẩn chuyển qua chatbox.</li>
                </ol>
            </ul>
