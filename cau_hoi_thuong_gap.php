...
<head>
    <title>LazaBA - Câu hỏi thường gặp  </title>
    <meta charset="utf-8">
                    ...
                    <div class="col-12">
                        <div class="header-menu-vertical pos-relative m-t-30">
                            <h4 class="menu-title link--icon-left"><i class="far fa-align-left"></i>DANH MỤC</h4>
                                ...
                                <li class="menu-item"><a class= "text-decoration-none" href="search.php">Tìm kiếm sản phẩm</a></li>
                                ...
                                <li class="menu-item"><a class= "text-decoration-none" href="cau_hoi_1.php">Làm thế nào để mua hàng trên LazaBA?</a></li>
                                    <li class="menu-item"><a class= "text-decoration-none" href="cau_hoi_2.php">Làm thế nào để đăng sản phẩm lên LazaBA?</a></li>
