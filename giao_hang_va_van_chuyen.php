...
<head>
    <title>LazaBA - Giao hàng và vận chuyển   </title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            <h1 class="h1">Giao hàng và vận chuyển   </h1>
            <p>
  ...
  <div
            ...
            <h1  class="h1">Việc giao hàng và vận chuyển sẽ do người bán tự thực hiện. Nếu có vấn đề gì bạn hãy liên lạc với người bán qua chatbox để được giải quyết một cách tốt nhất.    </h1 >
